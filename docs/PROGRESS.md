...
| [P1: Core Theme](tasks/phase-1-core-theme.md) | ███████░░░ 70% | 10 | 7/10 | 74h | Weeks 2-4 |
...
| **TOTAL** | **███░░░░░░░ 28%** | **39** | **11/39** | **337h** | **18 weeks** |
...
> Currently: **P1-8 (Dark Mode)** — unblocked. **P1-9 (Template Overrides)** — unblocked (P1-6 done). **P1-10 (Course Cards)** — blocked by P1-9. Critical path: P1-9 → P1-10.
...
| 3 | 2026-02-28 | P1-7 | Login page: 3 configurable layouts, background image, hero panel |
